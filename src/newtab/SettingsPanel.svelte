<script lang="ts">
	...
	$: syncedDate = $synced?.finished
		? new Date($synced?.finished).toISOString()
		: 'n/a'
...
<ul>
	...
	<li>
		...
		<input
			...
			id="autoHideControls"
			bind:value={$config.autoHideControls}
		/>
		<span>seconds</span>
	...
	<li>
		...
		<input
			...
			name="autoHideText"
			id="autoHideText"
			bind:value={$config.autoHideText}
		/>
		<span>seconds</span>
		<br /><span class="info">set to 0 to disable</span>
	</li>
	...
	<li>
		...
		<input
			...
			name="autoPlay"
			id="autoPlay"
			bind:checked={$config.autoPlay}
		/>
	</li>
	<li>
		<label for="startInFullScreen">start in fullscreen view</label>
		<input
			type="checkbox"
			name="startInFullScreen"
			id="startInFullScreen"
			bind:checked={$config.startInFullScreen}
		/>
	</li>
</ul>
<ul>
